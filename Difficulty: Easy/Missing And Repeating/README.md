...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>2 ≤ n ≤ 10<sup>6</sup><br>1 ≤ arr[i] ≤ n</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;